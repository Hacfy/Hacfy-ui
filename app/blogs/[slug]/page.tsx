      ...
      {post.heroImage && (
        <div className="relative h-64 sm:h-80 md:h-96 overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <Badge className="bg-secondary/90 text-white border-none font-semibold mb-3">
              {post.category}
            </Badge>
      ...
      <div className="py-8 px-4 bg-muted/30 border-b">
        <div className="max-w-4xl mx-auto">
          <Link href="/blogs">
            <Button
              variant="outline"
              className="mb-6 hover:bg-secondary/10 hover:border-secondary bg-transparent"
            >
          ...
          <Card className="glass-effect shadow-xl">
            <CardContent className="p-8 sm:p-12">
              <div className="prose prose-lg max-w-none">
                {formatContent(post.content, post.contentImages)}
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="py-16 px-4 bg-secondary/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Ready to strengthen your cybersecurity posture? Let our experts help
            you build a comprehensive security strategy.
          </p>
    ...
    lines.forEach((line, index) => {
      ...
      if (trimmedLine.startsWith("## ")) {
        ...
        elements.push(
          <h2
            key={index}
            className="text-2xl sm:text-3xl font-black gradient-text mb-4 mt-8"
          >
            {trimmedLine.replace("## ", "")}
          </h2>
        );
        ...
        elements.push(
          <h3
            key={index}
            className="text-xl sm:text-2xl font-bold text-foreground mb-3 mt-6"
          >
            {trimmedLine.replace("### ", "")}
          </h3>
        );
        ...
        elements.push(
          <p
            key={index}
            className="text-base sm:text-lg leading-relaxed mb-4 text-muted-foreground font-semibold"
          >
            {trimmedLine}
          </p>
        );
        ...
        elements.push(
          <p
            key={index}
            className="text-base sm:text-lg leading-relaxed mb-4 text-muted-foreground"
          >
            {trimmedLine}
          </p>
        );
